...
# 4. القائمة الجانبية (تم إصلاح مشكلة المسافات)
with st.sidebar:
...
if prompt := st.chat_input("اسأل لُجّ أي سؤال عن الرخصة المهنية..."):
    ...
    with st.chat_message("assistant"):
        ...
        # استدعاء المفتاح وتنظيفه من أي مسافات مخفية
        ...
        if not api_key:
            ...
            try:
                ...
                st.error(f"خطأ في الاتصال بخوادم الذكاء الاصطناعي: {e}")
